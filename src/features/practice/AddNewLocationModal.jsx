...
const AddNewLocationModal = ({ open, onClose, onSave }) => {
    ...
    const canSave = form.locationName.trim().length > 0;
    ...
    return (
        ...
        >
            <div className="epp-modal-head">
                <span className="epp-modal-title">Add New Location</span>
                <Button
                    type="text"
                    icon={<CloseOutlined />}
                    onClick={onClose}
            ...
            <div className="epp-field" style={{ marginBottom: 14 }}>
                <label className="epp-label">Location Name</label>
                <Input
            ...
            <div className="epp-grid epp-grid-3">
                <div className="epp-field">
                    <label className="epp-label">Location ID</label>
                    <Input
